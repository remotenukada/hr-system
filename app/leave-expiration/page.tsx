          ...
          <tbody>
            {expirationRows.length === 0 ? (
              ...
              expirationRows.map((row) => (
                ...
                >
                  <td className="p-3">{row.employeeNo}</td>

                  <td className="p-3 font-medium">{row.name}</td>

                  <td className="p-3">{row.leaveTypeName}</td>
                  ...
                  <td className="p-3 font-medium">{row.days.toFixed(1)}日</td>

                  <td className="p-3">{formatGrantType(row.grantType)}</td>
                  ...
                  <td className="p-3">
                    ...
                    >
                      {getStatusLabel(row.daysUntil, row.alreadyExpired)}
                    </span>
                  </td>
