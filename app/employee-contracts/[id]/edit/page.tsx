            ...
            <div className="md:col-span-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <label className="text-sm font-medium text-gray-700">
                  ...
                  <input
                    type="text"
                    name="treatmentDeskDepartment" defaultValue={contract.treatmentDeskDepartment ?? ""}
                ...
                <label className="text-sm font-medium text-gray-700">
                  ...
                  <input
                    type="text"
                    name="treatmentDeskPerson" defaultValue={contract.treatmentDeskPerson ?? ""}
                    className="mt-1 w-full rounded border bg-white p-2"
                  />
                </label>
                <label className="text-sm font-medium text-gray-700">
                  ...
                  <input
                    type="text"
                    name="treatmentDeskPhone" defaultValue={contract.treatmentDeskPhone ?? ""}
                    className="mt-1 w-full rounded border bg-white p-2"
                  />
                </label>
                <label className="text-sm font-medium text-gray-700">
                  ...
                  <input
                    type="email"
                    name="treatmentDeskEmail" defaultValue={contract.treatmentDeskEmail ?? ""}
                    className="mt-1 w-full rounded border bg-white p-2"
                  />
                </label>
              </div>
