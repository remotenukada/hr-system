...
export async function createEmploymentContractTemplate(
  ...
  await prisma.employmentContractTemplate.create({
    data: {
      ...
      treatmentDeskDepartment: optionalText(formData, 'treatmentDeskDepartment'),
      treatmentDeskPerson: optionalText(formData, 'treatmentDeskPerson'),
      treatmentDeskPhone: optionalText(formData, 'treatmentDeskPhone'),
      treatmentDeskEmail: optionalText(formData, 'treatmentDeskEmail'),
  ...
  const duplicated =
    await prisma.employmentContractTemplate.create({
      data: {
        ...
        treatmentDeskDepartment: current.treatmentDeskDepartment,
        treatmentDeskPerson: current.treatmentDeskPerson,
        treatmentDeskPhone: current.treatmentDeskPhone,
        treatmentDeskEmail: current.treatmentDeskEmail,
